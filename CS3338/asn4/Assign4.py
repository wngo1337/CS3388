...
from myAssignment4 import cameraMatrix
from implicitSphere import implicitSphere
from myAssignment4 import shader
...
objectList.append(implicitSphere(color=(120,50,225),T=transform().translate(Tx=2.0,Tz=-2.0),reflectance=(0.2,0.4,0.4,10.0)))
